...
public class Methods extends BaseTest {
    ...
    By productNameLocator  = By.cssSelector("ul.product-grid li");
    ...
    public boolean isLoginSuccessfull(By by){
        try {
    ...
    public void selectRandomProduct(){
        List<WebElement> elements = getAllProducts();

        int sizeOfElements = elements.size();

        int randomNo = generateRandomNumber(sizeOfElements);

        elements.get(randomNo).click();
